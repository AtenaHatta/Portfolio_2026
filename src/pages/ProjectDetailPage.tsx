                              ...
                              >
                                ...
                                >
                                  <AssetImage
                                    ...
                                    alt={
                                      (project.sections[slug] as SectionContent)
                                        .imageBelowFirstTitle || 'Section image'
                                    }
                                    width={800}
                                    height={
                            ...
                            if (
                              ...
                              return (
                                <div className="space-y-8">
                                        ...
                                        <div key={i} className="space-y-2">
                                          ...
                                          <ul className="ml-5 space-y-1 list-none">
                                            {sec.items.map((item, j) => {
                                              ...
                                              const keyPart =
                                                colonIndex >= 0
                                                  ? item.slice(0, colonIndex + 2)
                                                  : '';
                                              const valuePart =
                                                colonIndex >= 0 ? item.slice(colonIndex + 2) : item;
                                              return (
                                                <li
                                                  key={j}
                                  ...
                                  {(section as SectionContent).techStackBody != null &&
                                    (section as SectionContent).techStackBody!.length > 0 && (
                                      <div className="space-y-4">
                                        {(section as SectionContent).techStackBody!.map(
                                          (paragraph, i) =>
                                      ...
                                      <div key={i} className="space-y-2">
                                        ...
                                        <ul className="ml-5 space-y-1 list-none">
                                          {sec.items.map((item, j) => {
                                            const colonIndex = item.indexOf(': ');
                                            const keyPart =
                                              colonIndex >= 0 ? item.slice(0, colonIndex + 2) : '';
                                            const valuePart =
                                              colonIndex >= 0 ? item.slice(colonIndex + 2) : item;
                                            return (
                                              <li
                              ...
                              <div className="space-y-4">
                                {body.map((paragraph, i) => (
                                  <div key={i} className="space-y-4">
                                    ...
                                    {section.imageAfterIndex === i &&
                                      section.imageAfterIndexSrc && (
                                        <div className="my-6">
                                          <button
                                            type="button"
                                            onClick={() =>
                                              setModalImage(section.imageAfterIndexSrc!)
                                            }
                                            className="block w-full text-left cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 rounded-lg"
                                          >
                                            <AssetImage
