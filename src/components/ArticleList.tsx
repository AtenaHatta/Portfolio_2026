      ...
      {displayArticles.map((article) => (
        ...
        >
          ...
          >
            {article.cover_image ? (
              (() => {
                ...
                const url1x = base
                  .replace('width=1000', 'width=192')
                  .replace(/height=\d+/, 'height=108');
                const url2x = base
                  .replace('width=1000', 'width=384')
                  .replace(/height=\d+/, 'height=216');
                return (
                  <img
                    src={url1x}
          ...
          <div className="flex-1">
            <p className="text-sm font-light mb-2" style={{ color: secondaryColor }}>
            ...
            <h3 className="text-xl font-light mb-2" style={{ color: colors?.background.text }}>
              {article.title}
            </h3>
            <div
              className="flex items-center gap-4 text-sm font-light mb-3"
              style={{ color: secondaryColor }}
            >
              ...
              <span className="flex items-center gap-1">
                ...
                {(
                  article.positive_reactions_count ?? article.public_reactions_count
                ).toLocaleString()}{' '}
                reactions
              </span>
            </div>
